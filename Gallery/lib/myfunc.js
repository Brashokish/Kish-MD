...
exports.tanggal = (numer) => {
    myMonths = ["January", "February", "March", "April", "May", "June", "July", "Agustus", "September", "October", "November", "December"];
    myDays = ['Monday', 'Tuesday', 'Wednseday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
